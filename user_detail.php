...
<body>
    ...
    <div class="container">  
        <h2 class="user"><?=$username?>'s posts</h2>    
    ...
    <footer class="footer"> 
        <a href="https://validator.w3.org/nu/?doc=http%3A%2F%2Fwww2.cs.uregina.ca%2F~hanley2d%2FA3%2Fuser_detail.html">Validate HTML</a>
    </footer>
